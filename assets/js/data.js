...
window.ADCA = {
  ...
  budgets: [
    { label: 'Budget 2025-2026',           slug: 'budget-2025-2026' , file: 'assets/pdf/budget-2025-2026.pdf' },
    { label: 'Budget 2024-2025',           slug: 'budget-2024-25' , file: 'assets/pdf/budget-2024-25.pdf' },
    { label: 'Budget 2024-2025 (Interim)', slug: 'budget-2024-25-interim' , file: 'assets/pdf/budget-2024-25-interim.pdf' },
    { label: 'Budget 2023-2024',           slug: 'budget-2023-24' , file: 'assets/pdf/budget-2023-24.pdf' },
    { label: 'Budget 2022-2023',           slug: 'budget-2022-2023' , file: 'assets/pdf/budget-2022-2023.pdf' },
    { label: 'Budget 2021-2022',           slug: 'budget-2021-22' , file: 'assets/pdf/budget-2021-22.pdf' },
    { label: 'Budget 2020-2021',           slug: 'budget-2020-2021' , file: 'assets/pdf/budget-2020-2021.pdf' },
    { label: 'Budget 2019-2020',           slug: 'budget-2019-20' , file: 'assets/pdf/budget-2019-20.pdf' },
    { label: 'Budget 2019-2020 (Interim)', slug: 'budget-2019-2020-interim' , file: 'assets/pdf/budget-2019-2020-interim.pdf' },
    { label: 'Budget 2018-2019',           slug: 'budget-2018-2019' , file: 'assets/pdf/budget-2018-2019.pdf' },
    { label: 'Budget 2017-2018',           slug: 'budget-2017-2018' , file: 'assets/pdf/budget-2017-2018.pdf' },
    { label: 'Budget 2016-2017',           slug: 'budget-2016-2017' , file: 'assets/pdf/budget-2016-2017.pdf' },
    { label: 'Budget 2015-2016',           slug: 'budget-2015-2016' , file: 'assets/pdf/budget-2015-2016.pdf' },
    { label: 'Budget 2014-2015(2)',        slug: 'budget-2014-20152' , file: 'assets/pdf/budget-2014-20152.pdf' },
    { label: 'Budget 2014-2015',           slug: 'budget-2014-2015' , file: 'assets/pdf/budget-2014-2015.pdf' },
    { label: 'Budget 2013-2014',           slug: 'budget-2013-2014' , file: 'assets/pdf/budget-2013-2014.pdf' },
    { label: 'Budget 2012-2013',           slug: 'budget-2012-2012' , file: 'assets/pdf/budget-2012-2012.pdf' },
    { label: 'Budget 2011-2012',           slug: 'budget-2011-2012' , file: 'budget-2011-2012.html' },
    { label: 'Budget 2010-2011',           slug: 'budget-2010-2011-2' , file: 'budget-2010-2011.html' },
    { label: 'Budget 2009-2010',           slug: 'budget-2009-2010', file: 'budget-2009-2010.html' },
  ],
